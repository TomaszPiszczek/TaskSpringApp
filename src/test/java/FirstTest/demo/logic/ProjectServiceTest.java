...
class ProjectServiceTest {
    ...
    @Test
    @DisplayName("should throw IllegalStateException when configuration ok and no project for a given id")
    void createGroup_configurationOk_And_noProjects_throwsIllegalArgumentException() {
        ...
        //then
        assertThat(exception).isInstanceOf(IllegalArgumentException.class).hasMessageContaining("Project with given d not found");
    ...
    void createGroup_while_noMultipleConfig_isFalse_And_unDoneGroupsExists_throwsIllegalStateException() {
        //GIVEN
        ...
        var exception = catchThrowable(() -> toTest.createGroup(LocalDateTime.now(), 0));
        //then
        assertThat(exception).isInstanceOf(IllegalStateException.class).hasMessageContaining("Only one undone group from project is allowed");


    }

    @Test
    @DisplayName("should throw IllegalStateException when configured  to allow just 1 group ok and no project for a given id")
    void createGroup_noMultipleConfig_And_noProjects_throwsIllegalArgumentException() {
        //Given
        var mockRepository = mock(ProjectRepository.class);
        when(mockRepository.findById(anyInt())).thenReturn(Optional.empty());
        //and
